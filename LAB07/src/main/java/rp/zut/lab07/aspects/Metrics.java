...
public class Metrics {
    ...
    @Around("execution(* rp.zut.lab07.components.Car.run(..))")
    ...
    @Before("execution(* rp.zut.lab07.components.Engine.start(..))")
    public void logEngineStart() {
        log.info("Engine is starting...");
    }

    @AfterReturning("execution(* rp.zut.lab07.components.Engine.start(..))")
    public void logEngineStartSuccess() {
        log.info("Engine started successfully.");
    }

    @AfterThrowing("execution(* rp.zut.lab07.components.Engine.start(..))")
